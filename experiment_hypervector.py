...
def main(board_size, experiment_name, sample_size, open_position, moves_before, message_size, message_bits, double_hashing, epochs, number_of_clauses, T, s, q, depth):
    ...
    for run in range(3):
        ...
        param_str = f"b{board_size}_samp{sample_size}_c{number_of_clauses}_T{T}_s{s}_q{q}_d{depth}_ms{message_size}_mb{message_bits}_op{open_position}"
